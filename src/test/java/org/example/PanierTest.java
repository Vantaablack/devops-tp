...
class PanierTest {
    ...
    void calculerTotalDoitRetournerLaSommeDessousTotaux() {
        ...
        assertEquals(4.50, panier.calculerTotal(), 0.001);
    }
    ...
    void panierAvecArticlesNeDoitPasEtreVide() {
        Panier panier = new Panier();
        Article article = new Article("REF-001", "Cahier", 2.00);
    ...
    void quantiteUneDoitEtreAcceptee() {
        Panier panier = new Panier();
        Article article = new Article("REF-001", "Agenda", 9.99);
    ...
    void prixEleveDoitFonctionner() {
        Panier panier = new Panier();
        Article article = new Article("REF-LUX", "Montre", 999.99);
    ...
    void panierAvecUnSeulArticleDoitFonctionner() {
        Panier panier = new Panier();
        Article article = new Article("REF-001", "Livre", 15.00);
    ...
    void plusieursArticlesDifferentsDansPanier() {
        ...
        Article a3 = new Article("REF-003", "Règle", 2.00);

        panier.ajouterArticle(a1, 2);
        panier.ajouterArticle(a2, 1);
        panier.ajouterArticle(a3, 3);
